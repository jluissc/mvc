    ...
    <div class="card">
        <div class="row no-gutters">
                        ...
                        <li>
                            <div class="message-center">
                                ...
                                <?php 
                                    ...
                                    $listachatUU = new chatCUControlador();            
                                    echo $listachatUU -> lista_chatCU_C();
                                 ?>
            ...
            <div class="card-body border-top" id="barraM" style="display: none;">
                <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/chat-caAjax.php" method="POST" data-form="mensaje" autocomplete="off">
