                    ...
                    <div class="breadcrumb__wrap">
                        <ul class="breadcrumb__list">
                            ...
                            <li class="is-marked">
                                ...
                                <a href="about.html">Nosotros</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="about">
                            <div class="about__container">
                                <div class="about__info">
                                    <h2 class="about__h2">Bienvenido a PEPSTORE</h2>
                                    <div class="about__p-wrap">
                                        <p class="about__p">Somos un grupo de amigos con disponibilidad para poder apoyar a nuestra region a crecer, 
                                            asi este proyecto sea pequeño es nuestro <br> GRANITO DE ARENA
                                        <br> Esta plataforma esta dirigida a todas las personas que desean comprar de las tiendas de nuestra region y tambien mencionar que puedes crear tu espacio virtual <a href="<?php echo SERVERURL ?>admin"> <strong>aquí</strong> </a>
                                        </p>
                                    </div>
                                </div>
                            </div>
