                        ...
                        <div class="shop-p">
                            ...
                            <div class="shop-p__collection">
                                ...
                                <?php 
                                    ...
                                    /*PRODUCTOS DE TIPO DE LA CATEGORIA */
                                    if ( isset($pagina[2]) and !empty($pagina[2])  ) {     
                                        // echo "tercera pagina";
                                        $idCategoria = $pagina[2];
                                            echo $productos -> typeCategoria_c($idCategoria);
                                    }
                                    /*TODAS LAS CATEGORIAS */// esta aun en prueba*********++
                                    elseif ( isset($pagina[1]) and !empty($pagina[1]) ) {                                 
                                        echo "segunda pagina";
                                    ...
                                    /*TODOS LOS PRODUCTOS*/
                                            ...
                                            echo $productos -> all_productos_C();
                                ...
                                <div class="pd-wrap">
                                    <div id="js-product-detail-modal">
                                        <div>
                                            ...
                                            <img class="u-img-fluid" src="<?php echo SERVERURL ?>view/images/product/product-d-1.jpg" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="<?php echo SERVERURL ?>view/images/product/product-d-2.jpg" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="<?php echo SERVERURL ?>view/images/product/product-d-3.jpg" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="<?php echo SERVERURL ?>view/images/product/product-d-4.jpg" alt=""></div>
                                        <div>

                                            <img class="u-img-fluid" src="<?php echo SERVERURL ?>view/images/product/product-d-5.jpg" alt=""></div>
                                    </div>
                                </div>
                                    ...
                                    <form class="pd-detail__form">
                                        <div class="pd-detail-inline-2">
                                            ...
                                            <div class="u-s-m-b-15">
                                                ...
                                                <button  class="btn btn--e-brand-b-2" type="submit">Add to Cart dotero</button></div>
                                        </div>
                                    </form>
                                </div>
                                <div class="u-s-m-b-15">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="success u-s-m-b-30">
                                <div class="success__text-wrap"><i class="fas fa-check"></i>
                                    ...
                                    <span>Item isss added successfully!</span></div>
                                <div class="success__img-wrap">

                                    <img class="u-img-fluid" src="<?php echo SERVERURL ?>view/images/product/electronic/product1.jpg" alt=""></div>
...
<script>
    serve = '<?php echo $serve ?>'
    let url = `${serve}ajax/pedidoAjax.php`
    articulosCarrito = JSON.parse( localStorage.getItem('pedidos') ) || []  ;
    if (articulosCarrito.length) {
        llenarCanasta()
    }else{
        document.getElementById('pedidosCarrito').innerHTML = `Sin pedidos`
    }
    function agregarCarro(id =0){
        datos = new FormData();
        ...
        .then( resp => resp.json() )
        .then( resp => guardarPedidos(resp))
    }
    function guardarPedidos(resp){
        let {id_prod, prod_nombre, prod_precio, prod_descuento} = resp;
        let pedido = {
            'id' : id_prod,
        ...
        if( articulosCarrito.some( curso => curso.id === pedido.id ) ) { 
            const cursos = articulosCarrito.map( curso => {
                if( curso.id === pedido.id ) {
            ...
            articulosCarrito = [...articulosCarrito, pedido];
        }
    ...
    function llenarCanasta(){
        let total = articulosCarrito.reduce((total, pedido) => total + (pedido.cantidad *pedido.precio), 0)
        let div = `<div class="mini-product-container 
            gl-scroll u-s-m-b-15">`;
        articulosCarrito.forEach(pedido => {
            div += `<div class="card-mini-product">
                    <div class="mini-product">
                        <div class="mini-product__image-wrapper">

                            <a class="mini-product__link" href="product-detail.html">

                                <img class="u-img-fluid" src="<?php echo SERVERURL ?>view/images/product/women/product8.jpg" alt=""></a></div>
                        <div class="mini-product__info-wrapper">
                            ...
                            <span class="mini-product__name">
                                ...
                                <a href="product-detail.html">${pedido.producto}</a></span>

                            <span class="mini-product__quantity">${pedido.cantidad} x</span>

                            <span class="mini-product__price">S/. ${pedido.precio}</span></div>
                    </div>
        ...
        document.getElementById('pedidosCarrito').innerHTML = div
    }
